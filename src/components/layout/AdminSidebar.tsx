...
const AdminSidebar = ({isOpen}:Props) => {
  ...
  return (
    <section className={`w-[180px] lg:w-[280px] z-20  bg-white h-screen lg:px-6 px-4 fixed left-0 top-0 pt-8  md:-translate-x-0 transition-all duration-700 ease-in-out ${!isOpen?'-translate-x-[180px]':'translate-x-0 '}`}>
